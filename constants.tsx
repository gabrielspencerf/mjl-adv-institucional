...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    icon: ClockIcon,
    items: [
      "Análise de tempo de contribuição e simulação de aposentadoria",
      "Planejamento de aposentadoria ideal",
      "Revisão e requerimento de benefícios junto ao INSS"
    ]
  },
  {
    title: "Direito Cível em Geral",
    icon: ScaleIcon,
    items: [
  ...
  {
    title: "Outras Atividades Jurídicas",
    icon: HeartHandshakeIcon,
    items: [
      "Consultoria jurídica personalizada",
      "Mediação e resolução de conflitos",
      "Atuação estratégica em processos judiciais"
    ]
  }
];
