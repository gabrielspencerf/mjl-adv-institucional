...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none bg-[#0a0605]">
        ...
        >
          <img
            ...
            className={`w-full h-full object-cover transition-all duration-1000 ease-out-expo ${imgLoaded ? 'opacity-50 blur-0 scale-100' : 'opacity-0 blur-lg scale-105'
              }`}
          />
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full pt-20 pb-20 lg:pb-0">
        {/* Staggered reveal animations applied to children */}
        <div className="max-w-3xl space-y-5 lg:space-y-8 text-center lg:text-left">

          {/* Google Review Social Proof Badge */}
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-6 reveal">
          ...
          <p className="text-stone-300 text-lg sm:text-xl leading-relaxed font-light max-w-xl mx-auto lg:mx-0 border-l-0 lg:border-l-2 border-mjl-gold pl-0 lg:pl-6 reveal delay-200">
            Atuação especializada em Direito Imobiliário, Direito de Família e Sucessões, Direito Civil, Direito Empresarial e demais áreas. Segurança para seu patrimônio e clareza para suas decisões.
          </p>
          ...
          <div className="pt-8 lg:pt-12 flex items-center justify-center lg:justify-start gap-8 border-t border-white/5 mt-6 lg:mt-8 reveal delay-500">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <a
          href="#sobre"
          className="flex flex-col items-center gap-2 opacity-60 hover:opacity-100 transition-opacity duration-500 ease-out-expo cursor-pointer focus:outline-none focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-mjl-gold rounded-lg p-2 animate-float"
